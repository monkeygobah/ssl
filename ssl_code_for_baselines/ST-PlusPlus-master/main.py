...
from utils import init_basic_elems
...
def main(args):
    ...
    valloader = DataLoader(valset, batch_size=4 if args.dataset == 'cityscapes' else 1,shuffle=False, pin_memory=True, num_workers=4, drop_last=False)
    ...
    if not args.plus:
        ...
        dataset = SemiDataset(args.data_root, 'label', None, None, args.unlabeled_id_path)
        ...
        trainset = SemiDataset(args.data_root, MODE, args.crop_size, args.labeled_id_path, args.unlabeled_id_path, args.pseudo_mask_path)
